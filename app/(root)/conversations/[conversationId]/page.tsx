...
//   return conversation ===undefined ? <div
//   className='w-full h-full flex items-center justify-center'>
//     <Loader2 className='h-8 w-8'/></div>:
//    conversation === null ? <p className=
...
//     </RemoveFriendDialog>
//     <Header name={(conversation.isGroup?conversation.name:
//       conversation.otherMember.username)||""
//     } imageUrl={(conversation.isGroup? undefined: conversation
